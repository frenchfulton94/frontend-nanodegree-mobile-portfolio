...
function updatePositions(){frame++;window.performance.mark("mark_start_frame");window.requestAnimationFrame(function(){var items=document.querySelectorAll('.mover');var phase=function(math){return Math.sin(math);};var tops=(document.body.scrollTop/1250);console.log(document.body.scrollTop);var left;for(var i=0;i<items.length;i++){left=items[i].basicLeft
items[i].style.left=left+100*phase(tops+(i%5))+'px';}});window.performance.mark("mark_end_frame");window.performance.measure("measure_frame_duration","mark_start_frame","mark_end_frame");if(frame%10===0){var timesToUpdatePosition=window.performance.getEntriesByName("measure_frame_duration");logAverageFrame(timesToUpdatePosition);}}
